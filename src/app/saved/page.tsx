    ...
    <main className="min-h-screen bg-gradient-to-b from-thistledown-3 via-thistledown-4/20 to-thistledown-1/20">
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        <header className="py-8 flex flex-col md:flex-row justify-between items-center mb-8">
          <div>
            <h1 className="text-4xl md:text-5xl font-display text-thistledown-5 mb-3 animate-float glow text-center md:text-left">
              Saved Blessings
            </h1>
            <p className="text-thistledown-5/80 max-w-2xl mb-4 text-center md:text-left">
              Your personally saved spiritual blessings
            </p>
          </div>
          
          <Link href="/" className="spirit-button bg-gradient-to-r from-thistledown-1/80 to-thistledown-5/80 text-thistledown-3 hover:from-thistledown-1 hover:to-thistledown-5 shadow-spirit hover:shadow-spirit-hover mt-4 md:mt-0">
        ...
        {isLoading ? (
          <div className="flex justify-center items-center p-12">
            <div className="w-16 h-16 relative animate-spin">
              <div className="absolute inset-0 rounded-full border-4 border-thistledown-4/20 border-t-thistledown-5"></div>
              <div className="absolute inset-2 rounded-full border-4 border-thistledown-3/20 border-t-thistledown-3 animate-pulse"></div>
            </div>
          </div>
        ) : savedBlessings.length === 0 ? (
          <div className="text-center p-12 bg-thistledown-3/10 backdrop-blur-sm rounded-2xl shadow-spirit">
            <div className="w-20 h-20 mx-auto mb-4 opacity-50">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z" />
              </svg>
            </div>
            <h2 className="text-xl text-thistledown-5 mb-4">No Saved Blessings Yet</h2>
            <p className="text-thistledown-5/80 mb-6">Your saved blessings will appear here. Go back and save some blessings.</p>
            <Link href="/" className="spirit-button inline-block bg-gradient-to-r from-thistledown-4/80 to-thistledown-5/80 text-thistledown-1 hover:from-thistledown-4 hover:to-thistledown-5 shadow-spirit hover:shadow-spirit-hover">
              Discover Blessings
            </Link>
          </div>
        ) : (
                ...
                <div className={`flip-card-inner h-full`}>
                  ...
                  <div className={`flip-card-front rounded-2xl glass ${blessing.style} ${blessing.pattern || 'pattern-mandala'} h-full p-5 flex flex-col shimmer-bg`}>
                    <div className="flex-grow flex items-center justify-center">
                      <p className={`text-base text-thistledown-3 text-center line-clamp-6 ${blessing.language === 'hindi' ? 'font-hindi' : ''}`}>
                        {blessing.text}
                      </p>
                    </div>
            ...
            <div className="p-8 flex flex-col min-h-[50vh]">
              ...
              <div className="flex justify-center space-x-4 mt-auto">
                <button 
                  ...
                  className="spirit-button bg-thistledown-1/80 text-thistledown-3 hover:bg-thistledown-1 shadow-spirit hover:shadow-spirit-hover flex items-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <button 
                  ...
                  className="spirit-button bg-thistledown-3/80 text-thistledown-5 hover:bg-thistledown-3 shadow-spirit hover:shadow-spirit-hover flex items-center"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
